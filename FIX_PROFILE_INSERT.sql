-- ============================================
-- FIX: Create RPC Function for Profile Insert
-- ============================================
-- This function bypasses RLS to create profile when trigger fails
...
BEGIN
  ...
  INTO v_profile_id, v_user_id, v_full_name, v_username, v_email;

...
import { Heart, Users, Calendar, Shield, Star, ChevronRight, Sparkles, Zap, Coffee, MapPin, Plus } from "lucide-react";
      ...
      <div className="sticky top-16 z-40 bg-background/95 backdrop-blur-md border-b border-border">
        <Tabs defaultValue="feed" className="w-full">
          <TabsList className="w-full justify-center bg-transparent h-12">
            ...
            <TabsTrigger value="explore" className="flex-1 data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none">
              Jelajahi
            </TabsTrigger>
          </TabsList>
          ...
          {/* Explore Content - Original Homepage */}
